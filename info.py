...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002607391308 -1002552737240').split()]  # For Multiple Id Use One Space Between Each.
