...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002607391308 -1002628331780 -1002324131717 -1002628331780').split()]  # For Multiple Id Use One Space Between Each.
